...
export class MusicService {
  ...
  header = {'Access-Control-Request-Headers': '*', 'Authorization': 'Bearer BQDdgPzjTzWUVQqAfK5eIc2HBU2Zr6FkIsteMsmhNCaGxTbDp4VsaLAc5NSS-gQCqMZ_f4AS0H-rAnEwmn_xG_eaJvP3meEbHV0gI-J0cpcSHYfAZH9y-zVGnKaliJqwcXgc0dCybgPdeB1t5TFzuq3oYuqGs0I'};
